...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(
        800,
        600,
        "Composite Reflection using Matrix Representation",
        NULL,
        NULL
    );
    ...
    Matrix3 F = reflectionMatrix();

    Matrix3 T = translationMatrix(tx, ty);

    // Reflection first, Translation second
    Matrix3 M = multiply(T, F);

    // ---------------------------------------------
    // PRINT MATRICES
    // ---------------------------------------------

    printMatrix(F, "Reflection Matrix (F)");
    printMatrix(T, "Translation Matrix (T)");
    printMatrix(M, "Composite Matrix (M = T x F)");
