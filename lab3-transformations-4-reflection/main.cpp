...
// Apply reflection matrix to a point
Point transformPoint(Matrix3 F, Point p)
{
    Point result;
...
int main()
{
    ...
    Point rp1 = transformPoint(F, p1);
    Point rp2 = transformPoint(F, p2);
    Point rp3 = transformPoint(F, p3);
