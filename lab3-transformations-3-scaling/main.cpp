...
// Apply scaling matrix to a point
Point transformPoint(Matrix3 S, Point p)
{
    Point result;
...
int main()
{
    ...
    Point sp1 = transformPoint(S, p1);
    Point sp2 = transformPoint(S, p2);
    Point sp3 = transformPoint(S, p3);

    addTriangle(sp1, sp2, sp3);
